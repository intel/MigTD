...
//!
//! This module provides hardcoded DCAP collateral (certificates, CRLs, TCB info)
//! that is returned when the DCAP library requests collateral via servtd_get_quote()
//! in AzCVMEmu emulation mode.

pub(crate) const HARDCODED_COLLATERAL: &[u8] = &[
