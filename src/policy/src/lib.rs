...
impl<'a> Report<'a> {
    pub const R_MRSEAM: Range<usize> = 16..64;
    pub const R_MRSEAMSIGNER: Range<usize> = 64..112;
    pub const R_ATTR_SEAM: Range<usize> = 112..120;
    pub const R_ATTR_TD: Range<usize> = 120..128;
    pub const R_XFAM: Range<usize> = 128..136;
    pub const R_MRTD: Range<usize> = 136..184;
    pub const R_MRCONFIGID: Range<usize> = 184..232;
    pub const R_MROWNER: Range<usize> = 232..280;
    pub const R_MROWNERCONFIG: Range<usize> = 280..328;
    pub const R_RTMR0: Range<usize> = 328..376;
    pub const R_RTMR1: Range<usize> = 376..424;
    pub const R_RTMR2: Range<usize> = 424..472;
    pub const R_RTMR3: Range<usize> = 472..520;
    pub const R_FMSPC: Range<usize> = 584..590;
    pub const R_TDX_TCB_COMPONENTS: Range<usize> = 590..606;
    pub const R_PCE_SVN: Range<usize> = 606..608;
    pub const R_SGX_TCB_COMPONENTS: Range<usize> = 608..624;
    pub const R_TDX_MODULE_MAJOR_VER: Range<usize> = 624..625;
    pub const R_TDX_MODULE_SVN: Range<usize> = 625..626;
    pub const R_MISC_SELECT: Range<usize> = 626..630;
    pub const R_ATTRIBUTES: Range<usize> = 634..650;
    pub const R_MRENCLAVE: Range<usize> = 666..698;
    pub const R_MRSIGNER: Range<usize> = 698..730;
    pub const R_ISV_PRO_ID: Range<usize> = 730..732;
    pub const R_ISV_SVN: Range<usize> = 732..734;
