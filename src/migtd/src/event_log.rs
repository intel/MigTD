...
pub const TAGGED_EVENT_ID_ENGINE: u32 = 0x3;
pub const TAGGED_EVENT_ID_SIGNER_ENGINE: u32 = 0x4;
pub const TAGGED_EVENT_ID_TEST: u32 = 0x32;

// MR index the event will be measured into
pub const MR_INDEX_SIGNER_ENGINE: u32 = 0x1;
pub const MR_INDEX_POLICY: u32 = 0x3;
pub const MR_INDEX_ROOT_CA: u32 = 0x3;
pub const MR_INDEX_ENGINE: u32 = 0x4;
