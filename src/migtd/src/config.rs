...
//
// FFS GUID of the 48-byte RTMR1 signer anchor produced by
// `policy::compute_signer_anchor` with domain tag "MIGTD-RTMR1-ANCHOR-V2".
// It binds the root certificate, leaf Subject DN, SAN presence/value, and
// dedicated signer EKU. See doc/policy_v2.md for the DER encoding formula.
