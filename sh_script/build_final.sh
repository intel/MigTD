...
function populate_layout() {
    ...
    cargo run -- -t memory ../../../../config/shim_layout.json -o ../../td-layout/src/runtime.rs
    popd
}
...
function final_test_td_payload() {
    ...
    cargo run -p td-shim-tools --features="enroller" --bin td-shim-enroll \
            ...
            -f F10E684E-3ABD-20E4-5932-8F973C355E57 \
            ../../tests/test-td-payload/src/test.json \
            -f CA437832-4C51-4322-B13D-A21BD0C8FFF6 \
            ../../config/intel_root_sbx.der \
...
function enroll() {
    ...
    then
        cargo run -p td-shim-tools --features="enroller" --bin td-shim-enroll \
            ...
            -f CA437832-4C51-4322-B13D-A21BD0C8FFF6 ../../config/intel_root_sbx.der \
            -H SHA384 \
