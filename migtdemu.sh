...
show_usage() {
    ...
    echo "  --skip-policy-generation     Skip auto-generation of policy when using --policy-v2 with --mock-report"
    echo "                               (use when policy/chain files have already been generated by the caller)"
